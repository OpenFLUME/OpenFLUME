...
- Retention is hard-capped (`DIARY_EVENT_CAP`, 200) with a tiered eviction policy (lifecycle anchors and warnings outlive routine info) and honest accounting: `emitted = retained + dropped + coalesced` always.
