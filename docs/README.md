...
- [Regenerative cooling example](regen-cooling-example.md) provides a worked conjugate heat-transfer design point for a LOX/RP-1 booster chamber jacket, including derivation, assumption ledger, channel-count trade, and results.
